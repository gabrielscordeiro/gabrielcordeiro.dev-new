...
export function Resume() {
    return (
        <div className="container">
            <div className="resume flex flex-col-reverse items-center justify-between p-5 py-10 md:p-10 md:py-20 lg:flex-row lg:gap-10 lg:py-32">
                <div className="about-me max-w-screen-md">
                    ...
                    <div className="flex flex-col items-center justify-center gap-8 md:flex-row md:justify-around lg:justify-normal">
                        <div className="flex max-w-56 items-center font-bold">
                            <div className="mr-4 flex items-center text-6xl md:text-7xl">
                                <CountUp end={10} duration={3} />
                                <span className="pl-1 text-5xl text-blue-700">+</span>
                            </div>
